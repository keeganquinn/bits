...
server {
    listen 80;
    listen [::]:80;
    server_name basslines-staging.qtk.io;
    ...
    location / {
        return 301 https://basslines-staging.qtk.io$request_uri;
    }
}
...
server {
    ...
    server_name basslines-staging.qtk.io;
    ssl on;
    ssl_certificate /etc/letsencrypt/live/basslines-staging.qtk.io/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/basslines-staging.qtk.io/privkey.pem;
    ...
    ssl_trusted_certificate /etc/letsencrypt/live/basslines-staging.qtk.io/chain.pem;
    add_header Strict-Transport-Security "max-age=31536000";

    access_log /var/log/nginx/basslines-staging.qtk.io-access.log combined if=$log_ua;
    error_log /var/log/nginx/basslines-staging.qtk.io-error.log warn;
