...
server {
    ...
    location / {
        return 301 https://freetunetv.com$request_uri;
    }
}
...
server {
    ...
    ssl on;
    ssl_certificate /etc/letsencrypt/live/freetunetv.com/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/freetunetv.com/privkey.pem;
