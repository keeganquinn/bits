...
server {
    ...
    ssl_certificate_key /etc/letsencrypt/live/tunetvonline.com/privkey.pem;
...
server {
    ...
    access_log /var/log/nginx/tunetvonline.com-access.log combined if=$log_ua;
    error_log /var/log/nginx/tunetvonline.com-error.log warn;
